...
case $choice in
[yY]*) echo 'This may take a while.' && echo Note: Not even root has permissions to access certain files. && sleep 2 && sudo dir -AR --color=yes / 2>&1 | tee fsout.log && echo Done! Output saved to fsout.log && echo Console will be cleared momentarily. ;;
[nN]*) echo 'This may take a while.' && sleep 2 && dir --color=yes -AR / 2>&1 | tee fsout.log && echo Done! Output saved to fsout.log && echo Console will be cleared momentarily. ;;
